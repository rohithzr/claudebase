...
echo ""
echo -e "Next steps:"
echo -e "  ${BOLD}/claudebase:push${NC}   — Push current config to GitHub"
echo -e "  ${BOLD}/claudebase:pull${NC}   — Pull config from GitHub"
echo -e "  ${BOLD}/claudebase:status${NC} — Check sync status"
